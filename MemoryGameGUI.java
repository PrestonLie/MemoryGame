...
public class MemoryGameGUI extends JFrame 
{
   ...
   */
  public boolean playSequence(String[] sequence, double delay, int[] randomSeq, int[] buttonSeq)
  {
    delay *= 1000;
    ...
    for (int i = 0; i < sequence.length; i++ )
    {
      ...
      gameButtons[buttonNum].setText(sequence[randomSeq[buttonNum]]);
      answer = answer + sequence[randomSeq[i]];
      // wait a bit
      try
      {
        Thread.sleep((int)delay);
